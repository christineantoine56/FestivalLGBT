	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="champs-persos">
			<?php
				...
				$recompense = get_post_meta($post->ID, 'Récompense', true);
			...
			<?php if(false === empty($pays)): ?>
				...
				<i class=”champs-persos-label”/>
			<?php echo $pays ?></span>
			<?php endif; ?>

			<?php if(false === empty($annee)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”> - </i>
			<?php echo $annee ?></span>
			<?php endif; ?>
			...
			<?php if(false === empty($realisateur)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>de  </i>
			<?php echo $realisateur ?></span>
			<?php endif; ?>
			<?php if(false === empty($acteurs)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”>avec</i>
			...
			<?php if(false === empty($recompense)): ?>
				<span class="champs-persos-item">
				<i class=”champs-persos-label”></i>
			<?php echo $recompense ?></span>
			<?php endif; ?>
